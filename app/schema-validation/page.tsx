      ...
      <div className={styles.page}>
        ...
        <section className="page-section">
          ...
          <div className={styles.toolbar}>
            ...
            <SearchBar placeholder="Search pages..." value={searchTerm} onChange={setSearchTerm} />
          </div>

          {/* Table card */}
          <DataTable
            title="Validation Results"
            subtitle={loading ? "Loading..." : `Showing ${filteredItems.length} of ${totalPages} pages`}
            columns={[
              { key: "page", label: "Page URL / Name" },
